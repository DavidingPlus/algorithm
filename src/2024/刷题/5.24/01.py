...
# 一个关键点就是 f 数组每个位置 i 维护的是从该位置往前的 lowbit(i) 长度的区间的和， lowbit 独特的性质决定了 i + lowbit(i) 能迭代到下一个更大的区间，并且新区间能覆盖原区间。比如 3(011) + lowbit(3)(1) 到 4(100) ，这样在维护 f 数组的时候迭代加上 lowbit(i) 即可，求和的时候反过来即可
# 结合图 01-树状数组.png 理解
